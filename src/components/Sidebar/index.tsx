...
//                   {/* Logout Button */}
//                   <button
//                     className="flex items-center space-x-1 bg-boxColor text-start text-white w-full rounded hover:bg-gray-600"
//                     onClick={handleLogout}
//                   >
//                     <Icon icon="mdi:logout" />
//                     <p>Logout</p>
...
//                 {/* <DashboardComponent /> */}
//               </TabsContent>
//               <TabsContent value="notifications" className="text-white">
...
//               </TabsContent>
//               <TabsContent value="ads" className="text-white">
//                 Advertisements Content
//               </TabsContent>
//               <TabsContent value="blogs" className="text-white">
//                 Blogs Content
//               </TabsContent>
//             </Tabs>
//           </div>
...
// //               <TabsList className="flex flex-col space-y-2 w-full text-white">
// //                 <TabsTrigger value="dashboard" className="bg-orange-400">Dashboard</TabsTrigger>
